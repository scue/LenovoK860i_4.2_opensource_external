...
#ifdef WAPI
static void mlme_event_auth_wapi_enable(struct wpa_driver_nl80211_data *drv,
		       ...
		       struct nlattr *cookie, struct nlattr *sig)
{
	...
	case NL80211_CMD_UNPROT_DISASSOCIATE:
		...
		break;
#ifdef WAPI
	case NL80211_CMD_AUTH_WAPI_ENABLE:
		mlme_event_auth_wapi_enable(drv, EVENT_AUTH_WAPI_ENABLE,
						nla_data(frame), nla_len(frame));
		break;
#endif
	default:
		      ...
		      const u8 *key, size_t key_len)
{
	...
	case WAPI_ALG_SMS4:
		wpa_printf(MSG_DEBUG, "%s: WAPI_ALG_SMS4\n", __func__);
   		NLA_PUT_U32(msg, NL80211_KEY_CIPHER, WLAN_CIPHER_SUITE_SMS4);
		break;
#endif
	...
	struct wpa_driver_associate_params *params)
{
	...
	wpa_hexdump(MSG_DEBUG, "  * IEs", params->wpa_ie, params->wpa_ie_len);
 	...
 	if (params->wpa_ie[0] == WLAN_EID_WAPI) {
		wpa_printf(MSG_DEBUG, " * [WAPI] params->wpa_ie[0] == WLAN_EID_WAPI\n");
	...
	if (params->auth_alg & WPA_AUTH_ALG_OPEN)
		...
		wpa_printf(MSG_DEBUG, " * [WAPI] params->wpa_ie[0] == WLAN_EID_WAPI, Set type = NL80211_AUTHTYPE_OPEN_SYSTEM\n");
		type = NL80211_AUTHTYPE_OPEN_SYSTEM;
	}
#endif
	...
	{
		wpa_printf(MSG_DEBUG, "Failed, goto nla_put_failure\n");
		goto nla_put_failure;
	}
...
skip_auth_type:
	if (params->wpa_proto) {
		...
		if (params->wpa_proto & WPA_PROTO_RSN)
			...
			wpa_printf(MSG_DEBUG, "  * [WAPI] IW_AUTH_WAPI_VERSION_1");
			ver = NL80211_WAPI_VERSION_1;
		}
#endif
		wpa_printf(MSG_DEBUG, "  * [WAPI] WPA Versions 0x%x", ver);
		NLA_PUT_U32(msg, NL80211_ATTR_WPA_VERSIONS, ver);
	}
#ifdef WAPI
	else if(params->wpa_ie[0] == WLAN_EID_WAPI) {
		...
		wpa_printf(MSG_ERROR, " * [WAPI] its EID_WAPI\n");
		ver = NL80211_WAPI_VERSION_1;
		NLA_PUT_U32(msg, NL80211_ATTR_WPA_VERSIONS, ver);
		wpa_printf(MSG_DEBUG, " * [WAPI] params->wpa_ie && params->wpa_ie_len");
	}
#endif
	...
	if (params->pairwise_suite != CIPHER_NONE) {
		...
		if (params->wpa_ie[0] == WLAN_EID_WAPI) { /* wapi */
			wpa_printf(MSG_DEBUG, " * [WAPI] Set SUITES_PAIRWISE to WLAN_CIPHER_SUITE_SMS4");
		...
		if (params->wpa_ie[0] == WLAN_EID_WAPI) { /* wapi */
			...
			params->pairwise_suite = WLAN_CIPHER_SUITE_SMS4;
	...
	if (params->key_mgmt_suite == KEY_MGMT_802_1X ||
		...
		case KEY_MGMT_PSK:
			...
			break;
		case KEY_MGMT_WAPI_PSK:
			mgmt = WLAN_AKM_SUITE_WAPI_PSK;
			break;
		case KEY_MGMT_WAPI_CERT:
