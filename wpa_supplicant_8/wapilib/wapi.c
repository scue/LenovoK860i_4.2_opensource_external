...
static int waigroup_unicast_2_3_send(struct wapi_asue_st* wpa_s, u8* payload, int len_in)
{
	...
	hmac_sha256_w(tbuf+WAI_HDR, tbuflen-WAI_MIC_LEN-WAI_HDR, usk->mak,PAIRKEY_LEN,pos, WAI_MIC_LEN);
...
static int waigroup_unicast_3_3(struct wapi_asue_st* wpa_s, u8* payload, int len)
{
	...
	hmac_sha256_w(payload, len-WAI_MIC_LEN, usk->mak,PAIRKEY_LEN,mic, WAI_MIC_LEN);
